...
int set(cs * A, int r, int c, double v); /*returns 0,1,2,3*/
int mod(cs * A, int r, int c, double v); /*returns 0,1,2,3*/
int del(cs * A, int r, int c); /*returns 0,1,2,3*/

/*print COMPRESSED or TRIPLET matrices to console*/
int csc (const cs * A); /*returns 0,1*/
